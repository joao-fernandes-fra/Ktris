...
sealed class GameEvent {
    ...
    data class PieceLocked(val spinType: TSpinType, val linesCleared: Int, val isPerfectClear: Boolean) : GameEvent()
    data class LineCleared(val lineCount: Int, val isTetris: Boolean) : GameEvent()
